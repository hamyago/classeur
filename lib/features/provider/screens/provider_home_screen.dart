  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (auth.provider != null) {
        context.read<ProviderController>().initialize(auth.provider!);
      }
    });
  }
                ...
                children: [
                  ...
                  Expanded(
                    child: _StatCard(
                      ...
                      label: 'Total',
                      value:
                          '${ctrl.myInterventions.where((i) => i.isCompleted).length} interventions',
              ...
              if (ctrl.pendingRequests.isEmpty)
                ...
                ...ctrl.pendingRequests
                    .map((req) => _RequestCard(
                          request: req,
                          onAccept: () => ctrl.acceptIntervention(req.id),
              ...
              children: [
                Expanded(
                  child: OutlinedButton(
                    onPressed: () =>
                        ctrl.startIntervention(intervention.id),
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () =>
                        ctrl.completeIntervention(intervention.id),
  ...
  Widget build(BuildContext context) {
    ...
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.account_balance_wallet_outlined), label: 'Revenus'),
        BottomNavigationBarItem(icon: Icon(Icons.person_outline), label: 'Profil'),
      ],
    );
  }

  int _index(String route) {
    if (route.contains('history')) return 1;
    if (route.contains('earnings')) return 2;
