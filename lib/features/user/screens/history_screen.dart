...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<InterventionModel>>(
        stream: db.userInterventions(userId),
        builder: (_, snap) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, i) => _InterventionTile(
              ...
              onTap: () {
                if (list[i].isActive) {
                  context.go('/user/tracking/${list[i].id}');
                }
              },
            ),
          );
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Text(
                  _serviceIcon(intervention.serviceTypeId),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        timeago.format(intervention.createdAt, locale: 'fr'),
                        style: const TextStyle(
            ...
            Row(
              children: [
                _Info(
                  ...
                  label: intervention.providerName ?? 'Non assigné',
                ),
                const Spacer(),
                Text(
                  PriceCalculator.formatFcfa(intervention.totalPrice),
                  style: const TextStyle(
            ...
            if (intervention.userAddress != null) ...[
              ...
              _Info(
                ...
                label: intervention.userAddress!,
              ),
            ],
          ],
        ),
